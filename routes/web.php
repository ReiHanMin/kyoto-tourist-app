...
Route::get('/admin/garbage-bins/{garbageBin}/edit', [AdminController::class, 'edit'])->name('admin.garbage-bins.edit');
Route::put('/admin/garbage-bins/{garbageBin}', [AdminController::class, 'update'])->name('admin.garbage-bins.update');
Route::delete('/admin/garbage-bins/{garbageBin}', [AdminController::class, 'destroy'])->name('admin.garbage-bins.destroy');
